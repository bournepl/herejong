...
public class SelectedFlexMessageSupplier implements Supplier<FlexMessage> {

    @Autowired
    String orderid ;

    public SelectedFlexMessageSupplier(String orderid) {
    ...
    public FlexMessage get() {
        ...
        return new FlexMessage("คุณรับข้อเสนอไปแล้ว", bubble);
    }
    ...
    private Box createBodyBlock() {
        ...
        .margin(FlexMarginSize.MD)
                    .text("กรุณารอ Supllier ยืนยันสักครู่")
                    .color("#999999")
                    .weight(TextWeight.BOLD)
                    .align(FlexAlign.CENTER)
