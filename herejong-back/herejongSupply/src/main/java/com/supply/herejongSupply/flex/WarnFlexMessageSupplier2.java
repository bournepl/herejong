...
public class WarnFlexMessageSupplier2 implements Supplier<FlexMessage> {
    
    @Autowired
    String orderId ;
    
    public WarnFlexMessageSupplier2(String orderId) {
    ...
    public FlexMessage get() {
        ...
        return new FlexMessage("คุณยกเลิกงานนี้", bubble);
    }
    ...
    private Box createBodyBlock() {
        ...
        .margin(FlexMarginSize.MD)
                    .text("คุณยืนยันยกเลิกงานนี้แล้ว")
                    .color("#999999")
                    .weight(TextWeight.BOLD)
                    .align(FlexAlign.CENTER)
