...
public class WarnFlexMessageSupplier implements Supplier<FlexMessage> {
    @Autowired
    String orderId ;
    
 public WarnFlexMessageSupplier(String orderId) {
    ...
    public FlexMessage get() {
        ...
        return new FlexMessage("คุณยืนยันงานนี้ไปแล้ว", bubble);
    }
